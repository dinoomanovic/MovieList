...
import com.odin.movielist.widgets.bottombar.utils.createChain
...
internal open class ExpandableItemViewController(
        ...
        private val backgroundCornerRadius: Int,
    ...
    class Builder(private val menuItem: ExpandableBottomBarMenuItem) {
        ...
        @Px
        private var backgroundCornerRadius: Int = 0
        ...
        fun itemBackground(backgroundCornerRadius: Float,
            ...
            this.backgroundCornerRadius = backgroundCornerRadius.toInt()
